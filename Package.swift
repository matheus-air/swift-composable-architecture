...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "git@github.com:matheus-air/swift-dependencies", branch: "ios-11-compatibility"),
    .package(url: "https://github.com/pointfreeco/swift-identified-collections", from: "0.7.0"),
    .package(url: "git@github.com:matheus-air/swiftui-navigation", branch: "ios-11-compatibility"),
